...
export const portfolioData = {
  personal: {
    ...
    linkedin: 'https://linkedin.com/in/shabanya-kishore-yadagini-9a7a55249',
    resume: '/resume.pdf',
  },
  ...
  projects: [
    {
      ...
      description:
        'Benchmarking platform evaluating multiple systems across 75+ test cases',
    ...
    },
    {
      ...
      description:
        'Enterprise payment processing system handling 1M+ daily transactions with fraud detection',
      technologies: [
        'Java',
        'Spring Boot',
        'Kafka',
    ...
    },
    {
      ...
      description:
        'Built scalable data pipeline processing millions of events with real-time analytics',
      technologies: [
        'Python',
        'Apache Kafka',
        'Apache Spark',
    ...
    },
    {
      ...
      description:
        'Interactive dashboard for real-time business analytics and reporting',
